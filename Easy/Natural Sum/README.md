<h2><a href="https://www.geeksforgeeks.org/problems/stuti-and-her-problem5846/1?page=2&status=solved&sortBy=submissions">Natural Sum</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given N, find s such that sum of first s natural number is N.</span><br>
&nbsp;</p>
